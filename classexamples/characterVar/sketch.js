...
function setup() {
  ...
  faceButton.mousePressed(function(){
    ...
    //the button mousepressed function is tied to the general mouspepressed function
    faceColor = "orange";
...
function draw() {
  // put drawing code here
    ...
    // I want to change the background, split screen vertically
...
function keyPressed(){
  ...
  // if you press b, then key becomes "b" == "b" which is trues
